        ...
        <TextPageContainer pageName="О проекте">
            <TextPageSection id="about" title="О проекте">
                ...
                <p>
                    ...
                    <Link href="https://www.donationalerts.ru/r/thenyan">добровольными пожертвованиями</Link> (ведь лапшу быстрого приготовления для
                    стримеров нужно чем-то оплачивать).
                </p>
                <p>
            ...
            <TextPageSection id="copyright" title="Право­облада­­телям">
                <p>
                    ...
                    нашу почту <Link href={`mailto:${email}`}>{email}</Link> с вашего корпоративного почтового адреса со следующим содержанием:
                </p>
                <ul>
